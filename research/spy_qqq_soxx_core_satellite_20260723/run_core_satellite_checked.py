...
replacements = [
    ...
    ('str(selected_row.product)', 'str(selected_row["product"])', 3),
]
...
manifest["deterministic_hotfix"] = "use Series['product'] instead of Series.product at four output-only access sites"
